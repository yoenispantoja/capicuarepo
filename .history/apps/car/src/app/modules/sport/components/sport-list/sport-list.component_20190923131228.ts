import { SportDetailsComponent } from './../../../../../../../../.history/apps/car/src/app/modules/sport/components/sport-details/sport-details.component_20190923130831';
...
export class SportListComponent implements OnInit {
  ...
  addSport() {
    ...
    this.dialogAdd.open(SportAddComponent, dialogConfig).afterClosed().subscribe(value => {
