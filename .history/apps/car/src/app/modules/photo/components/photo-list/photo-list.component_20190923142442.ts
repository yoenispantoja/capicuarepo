...
import { take, takeLast, of } from 'rxjs/operators';
...
export class PhotoListComponent implements OnInit {
  ...
  getPhotos() {
    const source = of(this.photoService.getPhotos());
    this.subscriptionGetPhoto = this.photoService.getPhotos().pipe(takeLast(3)).subscribe(data => {
      this.photos = data;
      this.prepareTable();
    },
